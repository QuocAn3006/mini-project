...
let currentSlide = 0;
const btnNextImg = $(".icon__next");
const btnPrev = $(".icon__prev");
...
function addCart() {
  ...
  dataList.forEach((item, index) => {
    if (item != null) {
      ...
      let newDiv = document.createElement("div");
      newDiv.classList.add("no-item");
      newDiv.innerHTML = `
        <i class="img-no-item" style="background: url(https://static-kvfnb.kiotviet.vn/Content/WebPos/food-icon.svg) no-repeat">>
